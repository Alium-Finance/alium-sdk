...
export const EXCHANGE_CONFIG: ExchangeConfigT = {
  alium: {
    router: {
      ...
      [ChainId.MOONRIVER]: '0x1041738e7c7696AFc08E3C05401aD504eE647aE4',
...
export const LIQUIDITY_MIGRATOR_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MOONRIVER]: '0x6cFe00906a2074F41788b8Dc4fa66a4c13C2A3a3',
  ...
  [ChainId.AURORA]: '0x7C38870e93A1f959cB6c533eB10bBc3e438AaC11',
